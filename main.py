...
def show_main_page():
    ...
    st.image("1-полупериодный.jpg", caption="Рисунок 1. Схема однополупериодного выпрямителя", use_column_width=True)
...
def show_single_phase_bridge_page():
    ...
    # Добавляем изображение перед остальным кодом
    st.image("Мостовой.jpg", caption="Рисунок 2. Схема мостового выпрямителя", use_column_width=True)
